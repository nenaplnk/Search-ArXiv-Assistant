...
class ArXivAssistant:
    ...
    def optimize_query(self, user_query: str) -> str:
        ...
        Query: {user_query}
        """
        response = self._generate(prompt, max_tokens=100)[:55]
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                if self.is_question_about_articles(user_query) == 1:  # answer
                    if not has_papers:
                ...
                elif self.is_question_about_articles(user_query) == 0:
